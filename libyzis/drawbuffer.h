...
public:
     ...
     */
    inline int firstBufferLine() const
    {
        return mFirstBufferLine;
    }

    /**
     * Returns the last in-memory buffer line
     */
    inline int lastBufferLine() const
    {
        return mFirstBufferLine + mContent.count() - 1;
    }
     ...
     */
    inline const QList<YDrawSection> sections()
    {
        return mContent;
    }
     ...
     */
    inline const YDrawCell EOLCell() const
    {
        return mEOLCell;
    };
