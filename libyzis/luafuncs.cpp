...
{
    if(!YLuaEngine::checkFunctionArguments(L, 1, 1, "line", "line")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 2, 2, "setline", "line, text")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 3, 3, "insert", "line, col, text")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 3, 3, "remove", "line, col, nb")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 2, 2, "insertline", "line, text")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 1, 1, "appendline", "text")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 3, 3, "replace", "line, col, text")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 0, 0, "winline", "")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 0, 0, "wincol", "")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 0, 0, "scrline", "")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 0, 0, "scrcol", "")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 0, 0, "winpos", "")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 2, 2, "scrgoto", "line, col")) {
        return 0;
    }
...
int YLuaFuncs::screenwidth(lua_State *L)
{
    if(!YLuaEngine::checkFunctionArguments(L, 0, 0, "screenwidth", "")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 1, 1, "deleteline", "line")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 0, 0, "filename", "")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 2, 2, "color", "line, col")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 0, 0, "linecount", "")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 0, 0, "version", "")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 1, 1, "sendkeys", "text")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 3, 100, "highlight", "type, style, ...")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 1, 1, "yzdebug", "text")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 2, 2, "connect", "event (string), function (string)")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 1, 1, "source", "filename")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 1, 1, "setlocal", "option name")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 6, 6, "newoption", "option name, group name, default value, value, visibility (number), type (number)")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 2, 2, "map", "key, text")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 1, 1, "unmap", "key")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 2, 2, "imap", "key, text")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 1, 1, "iunmap", "key")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 2, 2, "omap", "key, text")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 1, 1, "ounmap", "key")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 2, 2, "vmap", "key, text")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 1, 1, "vunmap", "key")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 2, 2, "cmap", "key, text")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 1, 1, "cunmap", "key")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 2, 2, "nmap", "key, text")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 1, 1, "nunmap", "key (string)")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 2, 2, "noremap", "key, text")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 2, 2, "nnoremap", "key, text")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 2, 2, "vnoremap", "key, text")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 2, 2, "onoremap", "key, text")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 2, 2, "inoremap", "key, text")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 2, 2, "cnoremap", "key, text")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 0, 0, "matchpair", "")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 0, 0, "mode", "")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 1, 1, "edit", "filename")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 1, 1, "set", "option (string)")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 1, 1, "loadplugin", "plugin name")) {
        return 0;
    }
...
{
    if(!YLuaEngine::checkFunctionArguments(L, 1, 1, "setLuaReturnValue", "return value as string")) {
        return 0;
    }
